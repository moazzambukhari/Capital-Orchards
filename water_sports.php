...
<div class="container-fluid">
  <div class="row mt-5">
    <div class="col-md-6" style="margin-top: 28px;     padding: 0;">
      <img src="images/wsports1.jpg" class="img-responsive" alt="" style="height:500px !important; width:100%;">
    </div>
    ...
    <div class="one">
      <h1 class="head-line">JETSKI RACING</h1>
      </div> 
  ...
  <div class="row">
    ...
    <!-- <img src="images/build.jpg" class="img-responsive" alt="" style=" height:500px; width:100% !important; "> -->
      <div class="one">
      <h1 class="head-line">SWIMMING COMPITITION</h1>
      </div>  
    ...
    <div class="col-md-6 " style="padding: 0;">
      <img src="images/wsports2.jpg" class="img-responsive" alt="" style="height:500px !important; width:100%;">
    </div>
  </div>
