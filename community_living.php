...
<div class="container-fluid">
  <div class="row mt-5">
    <div class="col-md-6" style="margin-top: 28px;     padding: 0;">
      <img src="images/community.jpg" class="img-responsive" alt="" style="height:500px !important; width:100%;">
    </div>
    ...
    <div class="one">
      <h1 class="head-line">COMMUNITY LIVING</h1>
      </div> 
      <p>Introducing Skyview Complex, the stunning new addition to the downtown Manhattan skyline. A perfect blend of breathtaking architecture designed, with awe-inspiring interiors envisioned</p>
  ...
  <div class="row">
    ...
    <!-- <img src="images/build.jpg" class="img-responsive" alt="" style=" height:500px; width:100% !important; "> -->
      <div class="one">
      <h1 class="head-line">THE COMUNITY OVERVIEW</h1>
      </div>  
    ...
    <div class="col-md-6 " style="padding: 0;">
      <img src="images/living.jpg" class="img-responsive" alt="" style="height:500px !important; width:100%;">
    </div>
  </div>
